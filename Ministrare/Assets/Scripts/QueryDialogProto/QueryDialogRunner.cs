...
//        query.topics.Add(new DialogQueryTopic("testtopic"));
//        query.topics[0].conversations.Add(new TreeWithId("testconvo"));
//        query.topics[0].GetDialogTreeForId("testconvo").dialogNodes.Add(new DialogNode("This is a test response for conversation 'testconvo'", null, null));
//        query.topics[0].conversations.Add(new TreeWithId("testconvo2"));
//        query.topics[0].GetDialogTreeForId("testconvo2").dialogNodes.Add(new DialogNode("This is a test response for conversation 'testconvo2", null, null));
